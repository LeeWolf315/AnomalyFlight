...
public class Controller implements Observer {
    ...
    Button rewindButton;
    @FXML
    Button fasFowardButton;
    @FXML
    Button down;
    @FXML
    LineChart<Number, Number> cf1;
    @FXML
    LineChart<Number, Number> cf2;
    @FXML
    LineChart<Number, Number> anomalyGraph;
    @FXML
    Canvas graphs;
    @FXML
    NumberAxis x1;
    ...
    NumberAxis y;
    @FXML
    BubbleChart<Number, Number> welzlCircle;
    @FXML
    Gauge gps1;
    @FXML
    Gauge alt1;
