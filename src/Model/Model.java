...
public class Model extends Observable implements MyModel {
    ...
    public void setTimeSeriesAnomaly(TimeSeries ts){
        this.timeSeriesAnomaly=ts;
    }

private void openSocket2fg(){
    try {
...
public void LoadPluginClass(String FilePath, String ClassName){
        ...
        if(timer==null){
            ...
            timer.scheduleAtFixedRate(new TimerTask() {
                ...
                public void run() {
                    ...
                    flightGear(toFg);
                   // System.out.println(timeStep.get() + "  . line is : "+toFg+ " rate is"+rate);
    ...
    public void setSettings(int port,String ip,int playSpeed) {
        this.port=port;
        this.host=host;
